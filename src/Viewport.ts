...
export class Viewport {
  ...
  public syncScrollArea(): void {
    if (this.lastRecordedBufferLength !== this.terminal.currentScreen.lines.length) {
      // If buffer height changed
      this.lastRecordedBufferLength = this.terminal.currentScreen.lines.length;
      this.refresh();
    ...
    // Sync scrollTop
    const scrollTop = this.terminal.currentScreen.ydisp * this.currentRowHeight;
  ...
  private onScroll(ev: Event) {
    ...
    const diff = newRow - this.terminal.currentScreen.ydisp;
